...
export default function Component() {
    return (
        <div className="flex container mx-auto mt-2 items-center justify-between px-4 py-2 bg-white dark:bg-gray-800">
            <Link href="/" className="flex items-center gap-2" prefetch={false}>
                <InstaCaptIcon className="h-10 w-10"/>
            ...
            <Sheet>
                ...
                <SheetContent side="left">
                    <SheetTitle className='text-purple-500'>InstaCapt.me</SheetTitle>
                    ...
                    <SheetFooter>
                        <SheetClose asChild>
                            <div className='flex -mx-2 mt-5'>
                                ...
                                <a
                                    href='https://github.com/Amrod92/instacapt.me'
                                    target='_blank'
                                    className='mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-purple-500 dark:hover:text-purple-400'
                                    aria-label='Github'
                                >
...
function InstaCaptIcon(props) {
    return (
        <Image
            {...props}
            src={instacapt_logo}
            alt='InstaCapt.me logo'
            width={50}
            height={50}
        />)
}